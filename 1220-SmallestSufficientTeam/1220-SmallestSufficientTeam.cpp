// Last updated: 08/12/2025, 17:33:10
// class Solution {
// public: vector<int> ans;
//     vector<int> smallestSufficientTeam(vector<string>& r, vector<vector<string>>& pep) {
//        ans = {-1,0,4,6,7,8,8,8,8,9,0,0}; 
//         set<string> st;
//         for(auto it:r)
//            st.insert(it);
...
//         return ans;
//     }
//     void solve(set<string>& st ,vector<vector<string>>& pep , int ind,vector<int> &temp )
//     {
//          if(st.size() == 0)
//          {
